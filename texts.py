...
TEXTS = {
    'es': {
        ...
        'squad_name_repeated': "El nombre de escuadrón \'{group_name}\' ya está en uso, por favor prueba con otro.",
        ...
        'group_has_eliminated': "Grupo '{group_name}' eliminado.",
    ...
    'en': {
        ...
        'group_saved': "Group saved as '{group_name}'.",
        'advice_group_saved': "Warning, {user} has registered the group {group_name}. If it is not recognized, use:\n/remove {group_name}",
        'no_group_saved': "No groups saved.",
        'actual_groups': "Current groups:\n",
        'squads_info_group': "{name}: participants: {count}, language: {lang}\n",
        'squad_name_repeated': "The squad name \'{group_name}\' is already in use, please try another one.",
        ...
        'group_has_eliminated': "Group '{group_name}' has been deleted.",
    ...
    'ru': {
        ...
        'group_saved': "Группа сохранена как '{group_name}'.",
        'advice_group_saved': "Внимание, {user} зарегистрировал группу {name_group}. Если это не ваша группа, используйте:\n/remove {name_group}",
        'no_group_saved': "Группы не сохранены.",
        'actual_groups': "Текущие группы:\n",
        'squads_info_group': "{name}: участники: {count}, язык: {lang}\n",
        'squad_name_repeated': "Название отряда \'{group_name}\' уже используется, попробуйте другое.",
        ...
        'group_has_eliminated': "Группа '{group_name}' удалена.",
